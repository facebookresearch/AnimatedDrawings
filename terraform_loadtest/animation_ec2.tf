  ...
  container_definitions = jsonencode([
    {
      ...
      "logConfiguration" : {
        ...
        "options" : {
          ...
          "awslogs-group" : "${aws_cloudwatch_log_group.animation_ec2_log_group.name}",
