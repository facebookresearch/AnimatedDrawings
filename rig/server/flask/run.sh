...
gunicorn server:app --access-logfile access.log --log-file error.log -w ${SKETCH_API_WSGI_WORKERS} --threads ${SKETCH_API_WSGI_THREADS} -b 0.0.0.0:5000 ; cat error.log
