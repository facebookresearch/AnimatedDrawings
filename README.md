...
_This project has been tested with macOS Ventura 13.2.1 and Ubuntu 18.04. If you're installing on another operating system, you may encounter issues._

We _strongly_ recommend activating a Python virtual environment prior to installing Animated Drawings.
...
To understand what we mean by _annotations_ here, look at one of the 'pre-rigged' character's [annotation files](examples/characters/char1/).
...
```bash
    (animated_drawings) torchserve % curl http://dev-60yfmd-alb-647026402.ap-northeast-1.elb.amazonaws.com/ping
